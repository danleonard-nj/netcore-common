...
namespace Common.Utilities.DependencyInjection.Extensions
{
		public static class DependencyInjectionExtensions
		{
				...
				public static void RegisterSettingsExport(this IServiceCollection serviceDescriptors, ISettingsExport settingsExport, IConfigurationBinder configurationBinder)
				{
						var instance = configurationBinder.BindConfiguration(settingsExport.Type);
