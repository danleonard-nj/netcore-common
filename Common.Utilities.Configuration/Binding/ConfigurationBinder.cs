...
namespace Common.Utilities.Configuration.Binding
{
		...
		{
				public ConfigurationBinder(IManagedConfiguration configuration, bool addAzureKeyVault = false)
				{
				...
				public object BindConfiguration(Type type)
				{
						...
						var configuration = _managedConfiguration.BuildDefaultConfiguration();
				...
				private void InjectKeyVaultVariables(object instance, IManagedConfiguration managedConfiguration)
				{
						...
						var keyVaultConfiguration = managedConfiguration.BuildAzureKeyVaultConfiguration();
